...
export default function AboutMe() {
  return (
    <div id="#about" className="h-96 relative w-full overflow-hidden bg-gradient-to-b from-slate-800 to-slate-900 flex flex-col items-center justify-center rounded-lg shadow-lg">
      {/* Background overlay */}
